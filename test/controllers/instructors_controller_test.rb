...
class InstructorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create instructor" do
    assert_difference('Instructor.count') do
      post instructors_url, params: { instructor: { category: @instructor.category, email: @instructor.email, full_name: @instructor.full_name, phone_n: @instructor.phone_n } }
    end
  ...
  test "should update instructor" do
    patch instructor_url(@instructor), params: { instructor: { category: @instructor.category, email: @instructor.email, full_name: @instructor.full_name, phone_n: @instructor.phone_n } }
